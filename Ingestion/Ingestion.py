...
##################      for orchestration
# -----------------------------------------
# PIPELINE ENTRY FUNCTION (for orchestrator)
# -----------------------------------------
# def run_ingestion():

#     logging.info("Running ingestion pipeline step")
...
"""
Bronze Layer - Weather API Ingestion

Calls Open-Meteo API,
adds metadata,
and stores immutable raw JSON into S3.
"""
...
def store_raw_data_s3(enriched_data):
    ...
    logging.info(f"Uploaded raw file: raw/weather/{file_name}")
...
def run_ingestion():
    ...
    logging.info("===== INGESTION STEP STARTED =====")
